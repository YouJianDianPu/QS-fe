...
* @Last Modified time: 2018-03-24 22:18:27
*/
...
var page = {
    ...
    loadAddressList : function(){
        ...
        _address.getAddressList(function(res){
            ...
            var addressListHtml = _qs.renderHtml(templateAddress, res);
    ...
    loadProductList : function(){
        ...
        _order.getProductList(function(res){
            var productListHtml = _qs.renderHtml(templateProduct, res);
