...
* @Last Modified time: 2018-03-24 17:47:07
*/
...
var addressModal = {
    ...
    bindEvent :  function(){
        ...
        this.$modalWrap.find('.address-btn').click(function(){
            ...
            // 验证不通过
                ...
                _qs.errorTips(receiverInfo.errMsg || '好像哪里不对了~');
            }
        });
    ...
    loadModal : function(){
        var addressModalHtml = _qs.renderHtml(templateAddressModal, {
